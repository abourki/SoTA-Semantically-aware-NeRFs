...
| **Datasets with URL**                           | **Venue**          | **#Scenes**           | **#Imgs**           | **Centricity**          | **Type**          | **Data Modalities**          | **Annotations**                           | **URL**                                                                                 |
|-------------------------------------------------|--------------------|-----------------------|---------------------|-------------------------|-------------------|------------------------------|-------------------------------------------|-----------------------------------------------------------------------------------------|
| **3DMV-VQA**                                    | CVPR 2023          | 5000                  | 600K                | S+O                     | Indoor            | RGB                          | Visual question & answer                  | [URL](https://vis-www.cs.umass.edu/3d-clr/}{\faLink})                                   |
| **NeRDS 360**                                   | ICCV 2023          | 75                    | 15k                 | S+O                     | Urban             | Synthetic                    | 3D object boxes; 2D panoptic segmentation |
| **ScanNet++**                                   | ICCV 2023          | 460                   | 3.7M                | S                       | Indoor            | RGB-D                        | 2D/3D panoptic segmentation               | https://cy94.github.io/scannetpp/                                      |
| **KITTI-360**                                   | PAMI 2022          | 10                    | 150K                | S+O                     | Urban             | RGB & LiDAR                  | 2D/3D object boxes; 2D panoptic segmentation| \makecell[l]{2D/3D object boxes                                                         |
...
| **nuScenes**                                    | CVPR 2020          | 1000                  | 1.4M                | S+O                     | Urban             | RGB & LiDAR                  | 3D object boxes; 2D panoptic segmentation | \makecell[l]{3D object boxes                                                            |
...
| **CLEVR**                                       | CVPR 2017          | -                     | 100K                | O                       | Indoor            | Synthetic                    | Visual question & answer                  | answer  |\Dhref{https://cs.stanford.edu/people/jcjohns/clevr/}{\faLink} |
...
| **KITTI**                                       | CVPR 2012          | 22                    | 15K                 | S+O                     | Urban             | RGB & LiDAR                  | 2D/3D object boxes; 2D panoptic segmentation| \makecell[l]{2D/3D object boxes                                                         |
